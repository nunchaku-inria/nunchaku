(* OASIS_START *)
(* DO NOT EDIT (digest: cd377f9b1617d8a1cf363b591e4e0cad) *)
...
let package_default =
  {
     ...
     includes =
       [
          ...
          ("src/core/types",
            ["src/core"; "src/core/terms"; "src/core/transformations"]);
          ("src/core/transformations",
            ["src/core"; "src/core/terms"; "src/core/types"]);
          ("src/core/terms",
            ["src/core"; "src/core/transformations"; "src/core/types"]);
          ("src/core",
            ["src/core/terms"; "src/core/transformations"; "src/core/types"]);
          ("qtest",
            [
               "src/core";
               "src/core/terms";
