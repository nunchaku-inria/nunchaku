...
(* OASIS_START *)
(* DO NOT EDIT (digest: 419c783711c5f60063c0896b45aa68e7) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         ["-use-ocamlfind"; "-menhir 'menhir --dump --explain' -j 0"];
     test =
       [
          ("all",
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/nunchaku/nunchaku";
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "enable the library for generating random data";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                     cs_name = "nunchaku_core";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("containers.data", None);
                           FindlibPackage ("containers.sexp", None);
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "nunchaku";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "nunchaku_parsers";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "src/parsers/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "nunchaku_core"];
                      bs_build_tools =
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "nunchaku_core";
                      lib_findlib_name = Some "parsers";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "nunchaku_backends";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/backends";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "nunchaku_core";
                           InternalLibrary "nunchaku_parsers";
                           FindlibPackage ("containers.sexp", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   {
                      lib_modules = ["CVC4"; "Kodkod"; "Paradox"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "nunchaku_core";
                      lib_findlib_name = Some "backends";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "nunchaku_transformations";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "nunchaku_core";
                      lib_findlib_name = Some "transformations";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "nunchaku_random";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Term_random"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "nunchaku_core";
                      lib_findlib_name = Some "random";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "nunchaku_core";
                           InternalLibrary "nunchaku_transformations";
                           InternalLibrary "nunchaku_parsers";
                           InternalLibrary "nunchaku_backends"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "nunchaku.ml"});
               Executable
                 ({
                     cs_name = "run_qtest";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "nunchaku_parsers";
                           InternalLibrary "nunchaku_transformations";
                           InternalLibrary "nunchaku_random";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Documentation of Nunchaku";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\159\204\140\176~Kv\168c\171t\1643$.\221";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
