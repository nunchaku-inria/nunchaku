...
(* OASIS_START *)
(* DO NOT EDIT (digest: c4d7a234f9d5469c286137322447b046) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         ["-use-ocamlfind"; "-menhir 'menhir --dump --explain' -j 1"];
     test =
       [
          ("all",
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["CVC4"; "Kodkod"; "Paradox"; "Smbc"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "nunchaku_core";
     ...
     oasis_digest =
       Some "\203\236*J\138\018\2381\139\208\235\028\132\205m\252";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
