...
(* OASIS_START *)
(* DO NOT EDIT (digest: 49844bd15c38100467392f10e11c869b) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         ["-use-ocamlfind"; "-menhir 'menhir --dump --explain'"];
     test =
       [
          ("all",
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("containers.iter", None);
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "types/TypePoly";
                           "types/TypeMono";
                           "transformations/Skolem";
                           "transformations/TypeInference";
                           "transformations/ElimPatternMatch";
                           "transformations/Monomorphization";
                           "transformations/ElimRecursion";
                           "transformations/ElimMultipleEqns";
                           "transformations/ElimIndPreds";
                           "transformations/ElimCopy";
                           "transformations/Polarize";
                           "transformations/Unroll";
                           "transformations/IntroGuards"
                        ];
                      lib_pack = true;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "k\255\174\236\031^n\211\236\153-<\207\\\2448";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
